...
<!-- section -->
<div class="section padding-80-top margin-80-bottom background-white">

    <!-- section title -->
    <div class="section-big-title harabara">
        Keep in Touch
    </div>
    <!-- #section title -->
    ...
    <div class="section-paragraph">
        Do you have a project that you would like to discuss? Or just want to say hello? <br>
        Drop us a line and we will get back to you as soon as we can!
    </div>
    <!-- #section paragraph -->
...
<div id="map" class="section map-section">
    ...
    <script type="text/javascript">
        jQuery('#map').gMap({
            ...
            markers: [
                {
                    address: 'Y-2, 20th Street, D.H.A Phase 1 Karachi Pakistan',
                    html: '',
                    popup: false,
                }
            ],
...
<!-- contact section -->
<div class="section contact-section background-white">
    ...
    <div class="contact-info">
        ...
        <!-- divider half -->
        <div class="divider-half background-black"></div>
        <!-- #divider half -->
        ...
        <p>
            Y-2, 20th Street, Phase-1 <br>
            DHA Karachi
        </p>

        <p>
            Phone: <span class="color-black">+92.334.701.8230</span> <br>
            Email: <span class="color-black">hello@smartheads.com.pk</span> <br>
            Web: <span class="color-black">www.smartheads.com.pk</span>
        </p>
