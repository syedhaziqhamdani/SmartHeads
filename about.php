...
<head>
    ...
    <title>SmartHeads - About us</title>
...
<!-- section -->
<div class="section our-section padding-80-top padding-left-right background-white">

    <!-- section title -->
    <div class="section-big-title" style="font-family: 'harabara_maisharabaramaisdemo';">
        Welcome to SmartHeads
    </div>
    <!-- #section title -->
    ...
    <div class="section-paragraph">
        A creative agency that builds awesome stuff all day, every day. And we’ve had <br>
        the privilege to work with some awesome clients.
    </div>
    <!-- #section paragraph -->
    ...
    <div class="our col-sm-12">
        ...
        <div class="our-description">
            ...
            <ul>
                ...
                <!--<li>After services</li>-->
            </ul>
            <ul>
                <li>User friendly solutions</li>
                <li>Latest technology development</li>
                <li>Creative and Exclusive designs</li>
                <!--<li>Etiam ligula elit, pulvinar non</li>-->
            </ul>
        </div>
        <!-- #our description  -->
    ...
    <!-- skills -->
    <div class="our skills col-sm-12">
        ...
        <div class="skill">
            ...
            <!-- bar -->
            <div class="skill-bar" data-bar="85"><span></span></div>
        </div>
        <!-- #skill -->
        <!-- skill -->
        <div class="skill">
...
<div class="section">
    ...
    <div class="FullWslider">
        ...
        <!-- FullWslider arrows -->
        <div class="arrow-left slide-arrow"><i class="fa fa-angle-left"></i></div>
        <div class="arrow-right slide-arrow"><i class="fa fa-angle-right"></i></div>
        <!-- #FullWslider arrows -->
...
<!-- team section -->
<div class="section section-border background-white padding-top team-section">
    ...
    <!-- section paragraph -->
    <div class="section-paragraph">
        Professional and outstanding ideas of our passionate team makes us unique in every sense. <br>
    ...
    <div class="team-peoples">
        ...
        <div class="team-people">
            ...
            <!-- image -->
            <div class="image">
                <img src="images/team-people-image-1.png" alt="">
            </div>
...
<!--                </div>-->
        ...
        <div class="team-people">
            ...
            <!-- image -->
            <div class="image">
                <img src="images/team-people-image-2.png" alt="">
            </div>
